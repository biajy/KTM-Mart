...
namespace KTM_MART.Areas.Customer.Controllers
{
					...
					Metadata = new Dictionary<string, string>
	{
		...
		//public IActionResult OrderConfirmation(string intent_id, int id)
		//{
		//	OrderHeader orderHeader = _unitOfWork.OrderHeader.GetFirstOrDefault(u => u.Id == id);
		//	  // Retrieve the Payment Intent from Stripe using the intent_id

		//	if(orderHeader.PaymentStatus != SD.PaymentStatusDelayedPayment)
		//	{
		//		var service = new SessionService();
		//		var service = new PaymentIntentService();
		//		var paymentIntent = service.Get(intent_id);
